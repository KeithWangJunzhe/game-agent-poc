...
- 推荐从仓库根目录入口 [`run_poc.py`](/Users/keith/Desktop/AI/codex/game-agent-poc/run_poc.py) 启动，这样不依赖当前工作目录
- 测试自然语言 harness 时优先用 [`harness.py`](/Users/keith/Desktop/AI/codex/game-agent-poc/python-poc/harness.py)，默认会调用本地 `ollama run gemma4:e2b`
- 最小复盘摘要可以直接用 [`analysis/single_match.py`](/Users/keith/Desktop/AI/codex/game-agent-poc/python-poc/analysis/single_match.py) 和 [`analysis/batch_analysis.py`](/Users/keith/Desktop/AI/codex/game-agent-poc/python-poc/analysis/batch_analysis.py)
